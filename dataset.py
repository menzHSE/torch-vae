...
def get_loaders(dataset_name, img_size, batch_size, root="./data"):
    ...
    train_loader, test_loader, classes = torchvision_load(batch_size, load_fn, img_size, root)
    return train_loader, test_loader, classes, num_img_channels 

def torchvision_load(batch_size, load_fn, img_size=(32,32), root="./data"):
...
if __name__ == "__main__":
    ...
    tr_loader, test_loader, classes, num_img_channels = get_loaders("mnist", img_size=img_size, batch_size=batch_size)
